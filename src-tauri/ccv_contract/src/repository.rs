...
use crate::{error::AppError, models::{CopyCategory, CopyItem, CopyItemValue, SearchResult}};

pub trait Repository {
    fn search(&self, query: Option<&str>, page: i32, page_size: i32, categories: Vec<CopyCategory>) -> Result<SearchResult, AppError>;
